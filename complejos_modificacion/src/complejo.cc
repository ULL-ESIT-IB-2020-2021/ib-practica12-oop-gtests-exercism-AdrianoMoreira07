...
Complejo operator*(const Complejo& num1, const int& num2) {
  Complejo resultado;
  resultado.real_ = num1.real_ * num2;
  resultado.imaginario_ = num1.imaginario_ * num2;
  return resultado;
}

Complejo operator*(const Complejo& num1, const double& num2) {
  Complejo resultado;
  resultado.real_ = num1.real_ * num2;
  resultado.imaginario_ = num1.imaginario_ * num2;
  return resultado;
